...
public class Point2D implements Comparable<Point2D>{
	...
	//return the polar angle between this point and that point(-pi <-> pi, 0 if equal
	...
	//return square of Euclidean distance between this and that point
	...
	//Compare other points relative to polar angle(between -pi/2 and pi/2) they make with this Point
	private class PolarOrder implements Comparator<Point2D>{
		public int compare(Point2D q1, Point2D q2){
			...
			else if (dy1 == 0 && dy2 ==0){  //3-collinear or horizontal
				if (dx1 >= 0 && dx2 <0) return -1;
				else if(dx2 >= 0 && dx1 <0) return 1;
				else return 0;
			}
			else return -ccw(Point2D.this, q1, q2); //both above and below
			//ccw() recomputes dx1, dy1, dx2, dy2
		}
	}
